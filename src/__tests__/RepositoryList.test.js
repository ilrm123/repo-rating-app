...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        expect(firstRepositoryItem).toHaveTextContent('Forks: 1.6k')
        expect(firstRepositoryItem).toHaveTextContent('Stars: 21.9k')
        expect(firstRepositoryItem).toHaveTextContent('Rating: 88')
        expect(firstRepositoryItem).toHaveTextContent('Reviews: 3')
        ...
        expect(secondRepositoryItem).toHaveTextContent('Forks: 69')
        expect(secondRepositoryItem).toHaveTextContent('Stars: 1.8k')
        expect(secondRepositoryItem).toHaveTextContent('Rating: 72')
        expect(secondRepositoryItem).toHaveTextContent('Reviews: 3')
